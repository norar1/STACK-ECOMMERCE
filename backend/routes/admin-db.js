...
import Updateitem from "../controller/admin-db/update-item.js";
...
router.delete("/DeleteItems/:idDeleteItems", DeleteItemById); // http://localhost:3000/api/admindb/DeleteItems

router.put("/Updateitem/:id", Updateitem); // http://localhost:3000/api/admindb/Updateitem
